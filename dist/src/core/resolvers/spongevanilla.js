...
class SpongeVanillaResolver {
     ...
     */
    async listVersions() {
        const data = await fetchJson(`${API_BASE}/groups/${GROUP}/artifacts/${ARTIFACT}/versions?limit=50`);
    ...
    async getLatestVersion() {
        ...
        if (!versions.length)
            throw new Error('No SpongeVanilla versions found');
...
//# sourceMappingURL=spongevanilla.js.map