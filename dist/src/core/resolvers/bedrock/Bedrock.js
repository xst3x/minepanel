...
class BedrockResolver {
    constructor(channel = 'stable') {
        ...
        this._versionCache = makeCache(this.channel === 'preview' ? 'bds-preview-version' : 'bds-stable-version', 2 * 60 * 60 * 1000);
        this._buildCache = makeCache(this.channel === 'preview' ? 'bds-preview-build' : 'bds-stable-build', 2 * 60 * 60 * 1000);
    }
