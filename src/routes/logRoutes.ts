...
router.get('/', authenticateToken, checkPermission('server.files.read'), async (req: any, res) => {
    try {
...
router.get('/tail', authenticateToken, checkPermission('server.files.read'), async (req: any, res) => {
