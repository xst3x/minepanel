...
const MAVEN_API_URL = 'https://maven.neoforged.net/api/maven/versions/releases/net/neoforged/neoforge';
class NeoForgeResolver {
    ...
    _mcVerToNfPrefix(mcVersion) {
        ...
        if (mcMajor < 21)
            return null; // legacy, not supported
