...
const E = {
    ...
    // Plugins (Java — Modrinth / Hangar)
    PLUGIN_NOT_FOUND:               'PLUGIN_NOT_FOUND',
    PLUGIN_INSTALL_FAILED:          'PLUGIN_INSTALL_FAILED',
    PLUGIN_INCOMPATIBLE:            'PLUGIN_INCOMPATIBLE',
    PLUGIN_INVALID_FILENAME:        'PLUGIN_INVALID_FILENAME',

    // PocketMine plugins (Poggit)
    POCKETMINE_WRONG_SOFTWARE:      'POCKETMINE_WRONG_SOFTWARE',
    POCKETMINE_PLUGIN_NOT_FOUND:    'POCKETMINE_PLUGIN_NOT_FOUND',
    POCKETMINE_INSTALL_FAILED:      'POCKETMINE_INSTALL_FAILED',
    POCKETMINE_INVALID_FILENAME:    'POCKETMINE_INVALID_FILENAME',
...
class AppError extends Error {
    ...
    constructor(code: any, status = 500, detail = null) {
    ...
    toResponse() {
        ...
        if (this.detail != null) {
            (body as any).detail = this.detail;
            (body as any).details = this.detail;
        }
        return body;
    }
}
...
export = { E, AppError, sendError, MESSAGES };
