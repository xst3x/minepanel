import vanillaResolver = require('./resolvers/vanilla')
import PaperResolver = require('./resolvers/paper')
import PurpurResolver = require('./resolvers/purpur')
import fabricResolver = require('./resolvers/fabric')
import forgeResolver = require('./resolvers/forge')
import quiltResolver = require('./resolvers/quilt')
import magmaResolver = require('./resolvers/magma')
import foliaResolver = require('./resolvers/folia')
import velocityResolver = require('./resolvers/velocity')
import waterfallResolver = require('./resolvers/waterfall')
import leavesResolver = require('./resolvers/leaves')
import pufferfishResolver = require('./resolvers/pufferfish')
import arclightResolver = require('./resolvers/arclight')
import mohistResolver = require('./resolvers/mohist')
import spongevanillaResolver = require('./resolvers/spongevanilla')
import neoforgeResolver = require('./resolvers/neoforge')
import bedrockResolvers = require('./resolvers/bedrock')
