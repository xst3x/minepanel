...
exports.BedrockVersionService = void 0;
exports.getBedrockVersions = getBedrockVersions;
const minecraft_bedrock_server_1 = require("minecraft-bedrock-server");
...
class BedrockVersionService {
    constructor(options = {}) {
        ...
        this.fetchLatestVersions = options.fetchLatestVersions ?? minecraft_bedrock_server_1.getLatestVersions;
    }
...
exports.BedrockVersionService = BedrockVersionService;
...
exports.default = bedrockVersionService;
//# sourceMappingURL=BedrockVersionService.js.map