...
import compatibility = require('./CompatibilityEngine')
 ...
 */
async function runUpdate(serverId: any, opts: any = {}) {
    const { targetVersion = 'latest', skipBackup = false } = opts as any;
...
export = { checkForUpdate, runUpdate, rollback, getState };
