...
import eventBridge = require('./discordEventBridge')
 ...
 */
async function createBot(botToken: any, guildId: any, serverIds: any[] = []) {
 ...
 */
async function updateBot(botId: any, { botToken, guildId, serverIds }: any = {}) {
...
export = { validateToken, createBot, updateBot, deleteBot, toggleBot, reprovisionServer };
