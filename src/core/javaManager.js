...
const ADOPTIUM_API = (version, os, arch) => `https://api.adoptium.net/v3/binary/latest/${version}/ga/${os}/${arch}/jdk/hotspot/normal/eclipse`;
function detectArch() {
...
async function getJavaPath(serverJavaPath) {
    ...
    if (serverJavaPath && serverJavaPath !== 'java')
        return serverJavaPath;
